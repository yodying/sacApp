  ...
  rendercloseButton = (text, onPress) => (
    <TouchableOpacity onPress={onPress}>
      <View style={styles.buttonClose}>
        <Text style={[{fontSize:20,color:'white',fontWeight:'500'},styles.fontstyle]}> X </Text>
      </View>
    </TouchableOpacity>
  );
  renderModalContent = () => (
